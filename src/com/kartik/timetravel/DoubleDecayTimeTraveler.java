 ...
 *
 */
public class DoubleDecayTimeTraveler extends SuperTimeTraveler {

	public DoubleDecayTimeTraveler(String name){
		super(name);
	}
	...
	public void adjust(Time unit, int amount, boolean ahead) {
		...
		if (result > getRemainingYearsOfTravel()){
			...
			this.setRemainingYearsOfTravel(this.getRemainingYearsOfTravel() - (2* result));
		}			
	}
}
